...
enum AdapterConfig_MessageType {
  ...
  AdapterConfig_MessageType_HMI_COMMAND = 20
};
...
const AdapterConfig_MessageType AdapterConfig_MessageType_MessageType_MAX = AdapterConfig_MessageType_HMI_COMMAND;
...
class AdapterConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:apollo.common.adapter.AdapterConfig) */ {
 public:
  ...
  static const MessageType HMI_COMMAND =
